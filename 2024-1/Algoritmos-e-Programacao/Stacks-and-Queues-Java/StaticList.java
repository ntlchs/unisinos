...
public class StaticList<E> implements List<E> {
  ...
  public void insert(E element, int pos)
    throws OverflowException, IndexOutOfBoundsException {
    ...
    for (int i = numElements - 1; i >= pos; i--) elements[i + 1] = elements[i];
  ...
  public E remove(int pos)
    throws UnderflowException, IndexOutOfBoundsException {
  ...
  public int search(E element) {
    for (int i = 0; i < numElements; i++) if (
  ...
  public String toString() {
    String s = "";
    for (int i = 0; i < numElements; i++) s += elements[i] + " ";
    return s;
  }
}

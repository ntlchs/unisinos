...
# jal: jump and link
# jal <rótulo>
# Exemplo: jal le_inteiro_do_teclado  # salta para r�tulo `le_inteiro_do_teclado` e armazena endereço de retorno em $ra
...
inicio:
    ...
    jal le_inteiro_do_teclado  # chama funçãoo
    move $t0, $v0  # armazena inteiro lido em $t0
    li $v0, 4          
    la $a0, msg2       
    syscall
    move $a0, $t0   # a0 é o 10 argumento de syscall
    jal imprime_inteiro            
    
    # exibe mensagem e lê 20 número
    li $v0, 4       
    la $a0, msg     
    syscall         
